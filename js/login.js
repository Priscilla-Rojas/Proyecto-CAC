...
const verificar = () => 
    {    
        ...
        let pass = document.getElementById("passUsuario").value;
            ...
            {
                setTimeout(alert(`Bienvenido ${sessionStorage.getItem("usuarioSesion")}!`),1500);
                
            } else 
            {
            setTimeout(alert(`Usuario o contraseña incorrecto. Intente nuevamente o Regístrate`),1500);
            sessionStorage.setItem("usuarioSesion", "")
